...
<sup>* ***for the purposes of [geo3D](https://github.com/AdrianKriger/geo3D) a DEM is a bare earth raster grid. The surface of the Earth free of man-made and natural (trees, buildings, etc.) features.***
