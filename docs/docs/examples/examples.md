...
To ease the use of this workflow a range of parameter files *---with various settings---* are available. `runtime` metrics, for an [2022 M2](https://en.wikipedia.org/wiki/MacBook_Air_(Apple_silicon)), are included. 
